...
const getAllFromDB = (filters, paginationOptions) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const [managers, total] = yield Promise.all([
        (0, transactionManager_1.executeSafeQuery)(() => prisma_1.prisma.manager.findMany({
        ...
        (0, transactionManager_1.executeSafeQuery)(() => prisma_1.prisma.manager.count({ where: whereConditions })),
    ]);
    return {
        meta: {
            total,
...
const getByIdFromDB = (id) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield (0, transactionManager_1.executeSafeQuery)(() => prisma_1.prisma.manager.findUnique({
        where: { managerId: id },
    }));
    if (!result) {
...
const updateOneInDB = (id, payload) => __awaiter(void 0, void 0, void 0, function* () {
    return yield (0, transactionManager_1.executeSafeTransaction)((tx) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        const existingManager = yield tx.manager.findUnique({
            where: { managerId: id },
        });
        if (!existingManager) {
        ...
        if (payload.profileImage &&
            ...
            const result = yield tx.manager.update({
                where: { managerId: id },
