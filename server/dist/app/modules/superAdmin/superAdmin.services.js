...
const getAllFromDB = (filters, paginationOptions) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const [superAdmins, total] = yield Promise.all([
        (0, transactionManager_1.executeSafeQuery)(() => prisma_1.prisma.superAdmin.findMany({
        ...
        (0, transactionManager_1.executeSafeQuery)(() => prisma_1.prisma.superAdmin.count({ where: whereConditions })),
    ]);
    return {
        meta: {
            total,
...
const getByIdFromDB = (id) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield (0, transactionManager_1.executeSafeQuery)(() => prisma_1.prisma.superAdmin.findUnique({
...
const updateOneInDB = (id, payload) => __awaiter(void 0, void 0, void 0, function* () {
    return yield (0, transactionManager_1.executeSafeTransaction)((tx) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        const existingsuperAdmin = yield tx.superAdmin.findUnique({
            where: { superAdminId: id },
        });
        ...
        if (payload.profileImage &&
            ...
            const result = yield tx.superAdmin.update({
                where: { superAdminId: id },
