...
import ModalDeleteManager from '@/components/shared/modals/authors/ModalDeleteManager';
import { dataGridClassNames, dataGridSxStyles } from '@/lib/utils';
import { useGetManagersQuery } from '@/state/api/managersApi';
import { Manager } from '@/state/types';
...
const ManagersComp = () => {
  ...
  const rows = managers?.data?.map((manager: Manager) => {
    ...
    return {
      ...
      profileImage: manager ? `${manager?.profileImage?.url}` : 'N/A',
      name: manager
